        ...
        <div class="col-sm">
          <label for="file" class="bold-label">Justificatif</label>
            ...
            <span id="file-name-admin">${
                bill.fileName === "null"
                    ? "Aucun fichier envoyé par le demandeur"
                    : bill.fileName
            }</span>
            
            <div class='icons-container d-flex flex-row align-items-center'>
            ${
                bill.fileName !== "null"
                    ? `
              <span id="icon-eye-d" data-testid="icon-eye-d" data-bill-url="${bill.fileUrl}"> ${eyeWhite} </span>
              <a href='${bill.fileUrl}'> ${downloadWhite} </a>
              `
                    : ``
            } 
            </div>
       ...
       `
        ...
        <div class="col-sm">
          ...
          <div class='input-field'>${
              bill.commentAdmin === null ? "" : bill.commentAdmin
          }
          </div>
        </div>
       `
